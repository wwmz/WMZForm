...
- (void)setupToolbars
{
    ...
    indexLabel.frame = CGRectMake(0, 10, 80, 30);
...
- (void)setupScrollView
{
    ...
    for (int i = 0; i < self.imageCount; i++) {
        ...
        UILongPressGestureRecognizer *tap = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(pushSave:)];
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    __block UILabel *la = _indexLabel;
